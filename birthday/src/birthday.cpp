...
int main (int argc, char *argv[])
{
	...
	screen = SDL_SetVideoMode (640, 480, 32, SDL_HWPALETTE | SDL_HWSURFACE |
			SDL_DOUBLEBUF | SDL_FULLSCREEN);

	Mix_OpenAudio (audio_rate, audio_format,
